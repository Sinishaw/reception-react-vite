  ...
  return (
    <div style={{ 
      ...
      <div style={{ width: '100%', maxWidth: '640px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <h2 style={{ fontSize: '28px', fontWeight: 700, letterSpacing: '-0.5px', margin: 0, textAlign: 'center' }}>Settings</h2>

        <div className="card" style={{ padding: '32px', width: '100%', boxSizing: 'border-box' }}>
          {stationId ? (
            /* ── Active Session ── */
            <>
              ...
              <hr style={{ border: 'none', borderTop: '1px solid var(--outline-variant)', opacity: 0.5, margin: '16px 0' }} />

              <p style={{ fontWeight: 700, color: 'var(--secondary)', marginBottom: '16px', textAlign: 'center', fontSize: '14px' }}>
